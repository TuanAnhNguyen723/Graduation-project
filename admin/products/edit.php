...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if($product->skuExists($_POST['sku'], $product_id)) {
...
<head>
    ...
    <meta content="Chỉnh sửa sản phẩm" name="description" />
            ...
            <nav class="topbar-custom d-flex justify-content-between" id="topbar-custom">    
                <ul class="topbar-item list-unstyled d-inline-flex align-items-center mb-0">                        
                    ...
                    <li class="mx-2 welcome-text">
                        <h5 class="mb-0 fw-semibold text-truncate">Chỉnh sửa sản phẩm</h5>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="text-muted font-14">Chỉnh sửa thông tin sản phẩm theo yêu cầu</p>
                                                ...
                                                <div class="form-section">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="description" name="description" rows="4"
                                                                  placeholder="Mô tả chi tiết về sản phẩm..."><?php echo htmlspecialchars($product_data['description']); ?></textarea>
                                                    </div>
                                                            ...
                                                            <select class="form-select" id="category_id" name="category_id">
                                                                ...
                                                                <?php foreach($categories as $cat): ?>
                                                                    <option value="<?php echo $cat['id']; ?>" 
                                                                            <?php echo ($product_data['category_id'] == $cat['id']) ? 'selected' : ''; ?>>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 mb-3">
                                                            ...
                                                            <input type="number" class="form-control" id="stock_quantity" name="stock_quantity" 
                                                                   min="0" value="<?php echo htmlspecialchars($product_data['stock_quantity']); ?>" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="text-center">
                                                                <img src="<?php echo htmlspecialchars($product_data['images']); ?>" 
                                                                     alt="Current Image" class="current-image mb-2">
                                                            </div>
                                                        </div>
                                                    <?php endif; ?>
                                                    
                                                    <div class="mb-3">
                                                        <label for="images" class="form-label">URL hình ảnh mới</label>
                                                        <input type="url" class="form-control" id="images" name="images" 
                                                               value="<?php echo htmlspecialchars($product_data['images']); ?>"
                                                ...
                                                <div class="d-grid gap-2">
                                                    <button type="submit" class="btn btn-primary btn-lg">
                                                        <i class="iconoir-save"></i> Cập nhật sản phẩm
                                                    </button>
